...
def main():
    ...
    print("Depositing ...")
    # Last argument is referral code which since it is depracated, we will always pass the amount 0 to it.
    ...
    # We time it by 95% so that it would be safer for us and we wouldn't get liquidated easily
...
def get_asset_price(price_feed_address):
    ...
    # The [1] at the end tells the compiler to get only the 1st index of what is returned from the latestRoundData function, which would be the price!
